...
import { Attachment, downloadAttachment, viewAttachment, getFileIcon, formatFileSize, getReadableMimeType } from '../utils/attachmentUtils';
        ...
        {attachments.map((attachment, index) => (
          ...
          >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex gap-2 mt-0.5">
                  ...
                  <span className="text-[9px] font-bold text-slate-400">
                    • {formatFileSize(attachment.attachmentData || '')}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-2 ml-3 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <button
                onClick={() => downloadAttachment(attachment, grievanceId)}
